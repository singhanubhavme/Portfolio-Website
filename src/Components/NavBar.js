                ...
                <Container maxWidth="xl">
                    <Toolbar disableGutters>
                        ...
                        <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                            ...
                            >
                                <MenuItem onClick={handleCloseNavMenu} style={{ display: 'flex', flexDirection: 'column' }}>
                                    ...
                                    >
                                        <a className='mobile-nav-link' href="https://blog.anubhavsingh.dev"><Typography sx={{ color: '', display: 'block', fontFamily: 'Roboto' }} textAlign="center">Blog</Typography>
                                        </a>
                                    </Button>
                                    <Button
                                    >
                        ...
                        <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' }, justifyContent: 'flex-end' }}>
                            ...
                            <Button
                            >
                                <a href="https://blog.anubhavsingh.dev"><Typography sx={{ my: 2, color: 'white', display: 'block', fontFamily: 'Roboto' }} textAlign="center">Blog</Typography>
                                </a>
                            </Button>
                            <Button
                            >
